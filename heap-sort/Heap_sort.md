...
![altText](https://btholt.github.io/complete-intro-to-computer-science/static/38d462612230f54d41456fd320ab8eaf/6af66/heap.png)

_Kelott, CC BY-SA 4.0 https://creativecommons.org/licenses/by-sa/4.0, via Wikimedia Commons_
...
- Make the array a max heap - To make a max heap, you'll run have to heapify on the first half of the array, going backwards. Your loop will looking something like this:
